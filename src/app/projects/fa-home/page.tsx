...
export default function PDP3() {
  ...
  return (
    <main className="pt-0 overflow-x-hidden">
      ...
      />
      <section className=" abhi w-full flex justify-center items-center">
        <Image
      ...
      <Foundations
        ...
        paddingMobileLower="px-[30px] md:pt-[30px] md:pb-[40px] pb-[30px]"
      ...
      <Strategy
        ...
        paddingMobileUpper="px-[30px] md:py-[43px] py-[30px]"
        paddingMobileLower="px-[30px] md:pt-[29px] md:pb-[43px] pb-[30px]"
        paddingXl="py-8 px-9 xl:px-[51px] xl:py-0 xl:-mt-[14px]"
        imageClass={
          isExpanded
            ? "w-full h-[400px] lg:w-[763px] md:h-[738px] lg:h-[1580px] object-cover"
            : "w-full h-[400px] lg:w-[763px] md:h-[738px] lg:h-[1177px] object-cover"
        }
