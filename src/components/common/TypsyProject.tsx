...
const Slide = (props: any) => {
  ...
  const translateX = useTransform(props.progress, [0, 1], [40 * direction, -40 * direction])
  return (
    <motion.div style={{x: translateX, left: props.left}} className="relative flex whitespace-nowrap md:ml-[-15%] ml-[-50%]">
