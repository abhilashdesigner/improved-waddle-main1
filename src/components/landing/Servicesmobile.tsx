...
export default function servicesmobile() {
  ...
  <section className="pb-[30px] mt-[0px] pl-[30px] w-[100%] servicesection ">
    <Slider {...settings} className="servicesmobile">
      <div>
	  <h3 className="font-normal text-[15px] font-nats text-[#351A12] uppercase mb-[18px] mt-0">Brand Identity & Strategy</h3>
		<Image
      ...
      <div>
	  <h3 className="font-normal text-[15px] font-nats text-[#351A12] uppercase mb-[18px] mt-0">Website Design & Development</h3>
		<Image
	  ...
	  <div>
	  <h3 className="font-normal text-[15px] font-nats text-[#351A12] uppercase mb-[18px] mt-0">Packaging Design</h3>
		<Image
	  ...
	  <div>
	  <h3 className="font-normal text-[15px] font-nats text-[#351A12] uppercase mb-[18px] mt-0">Illustration & Visual Assets</h3>
		<Image
	  ...
	  <div>
	  <h3 className="font-normal text-[15px] font-nats text-[#351A12] uppercase mb-[18px] mt-0">Editorial Design</h3>
		<Image
	  ...
	  <div>
	  <h3 className="font-normal text-[15px] font-nats text-[#351A12] uppercase mb-[18px] mt-0">Custom Invitations</h3>
		<Image
	  ...
	  <div>
	  <h3 className="font-normal text-[15px] font-nats text-[#351A12] uppercase mb-[18px] mt-0">Digital Ads & Campaign Assets</h3>
		<Image
	  ...
	  <div>
	  <h3 className="font-normal text-[15px] font-nats text-[#351A12] uppercase mb-[18px] mt-0">Social Media Creatives</h3>
		<Image
	  ...
	  <div>
	  <h3 className="font-normal text-[15px] font-nats text-[#351A12] uppercase mb-[18px] mt-0">Commissioned Paintings</h3>
		<Image
	  ...
	  <div>
	  <h3 className="font-normal text-[15px] font-nats text-[#351A12] uppercase mb-[18px] mt-0">Creative Direction & Consulting</h3>
		<Image
