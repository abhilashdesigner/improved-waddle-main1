...
const MeetCreator: React.FC = () => {
  ...
  const allParagraphs = [
    ...
    `Today, Mili partners with a full-stack developer and technologist who thrives across the digital spectrum, from modern frameworks and scalable systems to emerging technologies like AI and Web3. Together, they create digital experiences where visual expression meets functionality.`,
  ];
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full font-nats overflow-hidden px-[30px] py-11 lg:p-[50px] xl:pt-[94px] xl:pb-[100px] xl:px-[104px] bg-[#F0E5D4] justify-between">
      <div className="w-full lg:w-[40%] xl:w-[30%] h-auto text-left">
        <div className="flex flex-col">
          <h1 className="m-0 font-nats font-normal text-[15px] lg:text-[20px] mb-1 lg:mb-2 uppercase text-[#351A12]">
            Meet the Creator
          </h1>
          <h1 className="m-0 font-monthis font-normal text-[58px] lg:text-[96px] leading-none mb-[20px] lg:mb-0 text-[#351A12]">
            Mili Bajaj
          </h1>
        </div>
      </div>
      <div className="w-full lg:w-[60%] xl:w-[70%] flex flex-col justify-start pl-0 lg:pl-7 desktop-xl:pl-[19px]">
        {renderContent()}
      </div>
    </div>
  );
