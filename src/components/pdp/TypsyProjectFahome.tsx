...
const Slide = (props: any) => {
  ...
  return (
    <motion.div style={{x: translateX, left: props.left}} className="relative flex whitespace-nowrap md:ml-[80%] ml-[70%]">
  ...
  return (
    <div className="project-grid bottom-left">
				<a
				  ...
				  className="project mt-[0px] mb-[80px] md:mt-[0px] md:mb-[180px]"
				>
				  <div
